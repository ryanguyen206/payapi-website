    ...
    <div className='bg-secondary_black text-center py-10  lg:px-32 2xl:px-80  lg:flex lg:items-center justify-between'>
        ...
        <div>
          <ul className='text-primary_light mt-10 lg:mt-0 lg:space-y-0 space-y-4 md:text-md lg:flex lg:space-x-10'>
              <li className='hover:text-white cursor-pointer max-w-max mx-auto'>Pricing</li>
              <li className='hover:text-white cursor-pointer max-w-max mx-auto'>About</li>
              <li className='hover:text-white cursor-pointer max-w-max mx-auto'>Contact</li>
          </ul>
        </div>  
